...
public class Form_apply2 extends Form
{
	//
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	private void Form_apply2_Load(Object sender, tangible.EventArgs e)
	{
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
			///#region 显示下拉框
		ArrayList<operation_table> operation_tableList = new ArrayList<operation_table>();
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	private void button1_Click(Object sender, tangible.EventArgs e)
	{
		...
		LocalDateTime _ss_date = this.dateTimePicker1.Value;
		...
		{ //已经录入 "修改”
			...
			ss_table_2.setBH_blood(_BH_blood);
			ss_table_2.setbody_position(_body_position);
			ss_table_2.setcut_grade(_cut_grade);
			ss_table_2.sethepatitisB(_hepatitisB);
			ss_table_2.sethepatitisC(_hepatitisC);
			ss_table_2.setHIV(_HIV);
			ss_table_2.setoperation_id(_operation_id);
			ss_table_2.setspecial_infection(_special_infection);
			ss_table_2.setnarcosis_way(_narcosis_way);
			ss_table_2.setss_date(_ss_date);
			ss_table_2.setposition(_position);
			ss_table_2.setss_grade(_ss_grade);
			ss_table_2.setss_type(_ss_type);
			ss_table_2.setsyphilis(_syphilis);
			ss_table_2.settuberculosis(_tuberculosis);
			ss_table_2.setremarks(_remarks);
			ss_table_2.setillness_id(cur_visit.illness_id);
		...
		else
		{
			...
			ss_table_.setBH_blood(_BH_blood);
			ss_table_.setbody_position(_body_position);
			ss_table_.setcut_grade(_cut_grade);
			ss_table_.sethepatitisB(_hepatitisB);
			ss_table_.sethepatitisC(_hepatitisC);
			ss_table_.setHIV(_HIV);
			ss_table_.setoperation_id(_operation_id);
			ss_table_.setspecial_infection(_special_infection);
			ss_table_.setnarcosis_way(_narcosis_way);
			ss_table_.setss_date(_ss_date);
			ss_table_.setposition(_position);
			ss_table_.setss_grade(_ss_grade);
			ss_table_.setss_type(_ss_type);
			ss_table_.setsyphilis(_syphilis);
			ss_table_.settuberculosis(_tuberculosis);
			ss_table_.setremarks(_remarks);
			ss_table_.setillness_id(cur_visit.illness_id);
			...
			{ // 插入成功
				...
				patient_table_.setss_id(ss_table_.ss_id);
				patient_table_.setisInput(true);
	...
	private void label3_Click(Object sender, tangible.EventArgs e)
	{
	...
	private void button1_Click_1(Object sender, tangible.EventArgs e)
	{
		if (index_i == 0)
		{
			...
			if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
			{
				...
				boolean bool_t = IsPicture(ImagePath); //判断上传的图片是否有病毒
				if (bool_t)
				{
...
//C# TO JAVA CONVERTER TODO TASK: C# to Java Converter cannot determine whether this System.IO.MemoryStream is input or output:
				...
				{
					MessageBox.Show(String.format("上传的图片有病毒"));
				}
...
//ORIGINAL LINE: byte buffer;
			...
			fileClass = String.valueOf(buffer);
			buffer = reader.ReadByte();
			fileClass += String.valueOf(buffer);
			reader.Close();
			fs.close();
			if (fileClass.equals("255216") || fileClass.equals("7173") || fileClass.equals("13780") || fileClass.equals("6677"))
			{
...
//C# TO JAVA CONVERTER TODO TASK: There is no preprocessor in Java:
	...
	*/
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(Form_apply2.class);
...
//ORIGINAL LINE: this.btnClear.Font = new System.Drawing.Font("微软雅黑", 10.5F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
		...
		this.btnClear.Location = new System.Drawing.Point(166, 652);
...
//ORIGINAL LINE: this.btnOK.Font = new System.Drawing.Font("微软雅黑", 10.5F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
		...
		this.btnOK.Location = new System.Drawing.Point(664, 652);
...
//C# TO JAVA CONVERTER TODO TASK: Java has no equivalent to C#-style event wireups:
		...
		this.panel2.Size = new System.Drawing.Size(834, 360);
...
//ORIGINAL LINE: this.txt_remarks.Font = new System.Drawing.Font("微软雅黑", 15F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
		...
		// 
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
//ORIGINAL LINE: this.button1.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(65)))), ((int)(((byte)(141)))), ((int)(((byte)(109)))));
		this.button1.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(65)))), ((int)(((byte)(141)))), ((int)(((byte)(109)))));
//C# TO JAVA CONVERTER WARNING: Unsigned integer types have no direct equivalent in Java:
...
//C# TO JAVA CONVERTER TODO TASK: Java has no equivalent to C#-style event wireups:
		...
		this.Name = "Form_apply2";
		this.Text = "Form_apply2";
//C# TO JAVA CONVERTER TODO TASK: Java has no equivalent to C#-style event wireups:
		this.Load += new System.EventHandler(this.Form_apply2_Load);
